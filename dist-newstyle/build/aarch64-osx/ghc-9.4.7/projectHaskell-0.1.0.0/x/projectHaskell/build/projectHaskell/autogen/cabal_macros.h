...
/* package projectHaskell-0.1.0.0 */
#ifndef VERSION_projectHaskell
#define VERSION_projectHaskell "0.1.0.0"
#endif /* VERSION_projectHaskell */
#ifndef MIN_VERSION_projectHaskell
#define MIN_VERSION_projectHaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projectHaskell */
...
#define CURRENT_COMPONENT_ID "projectHaskell-0.1.0.0-inplace-projectHaskell"
